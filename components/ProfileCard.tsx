...
const ProfileCard: React.FC<ProfileCardProps> = ({ profile, onView, dragX }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col cursor-pointer" onClick={onView}>
      ...
      <div className="p-5 flex flex-col flex-grow">
          ...
          <p className="text-sm text-slate-600 my-3 flex-grow">
